...
public class Main {
 ...
 /*3. Ký tự đặc biệt trong Regex
    ...
    public static void main(String[] args) {
        //xuLyChuoi();
        String ten = kiemTraDauVao("ten", "^[a-zA-Z ]+$");
        //"^[a-zA-Z ]+$"  <=> "^[a-zA-Z\\s]+$"
        System.out.println("ten= " + ten);
        int tuoi = Integer.parseInt(kiemTraDauVao("tuoi", "^[0-9]+$"));
        System.out.println("tuoi= "+ tuoi);//"^[\\d]+$"
        String sdt= kiemTraDauVao("so dien thoai", "^[0-9]{10}$");
        System.out.println("sdt= "+ sdt);
        //kiểm tra số điện thoại có 10 số nhưng bắt đầu bằng só 0
        //kiểm tra số double: vd cân nặng
        //kiểm tra email có đuôi là @fpt.edu.vn
    }

    public static void xuLyChuoi() {
        String[] arrTen = {"Hoa", "hong", "Ngoc",
            "tuyet", "nhung"};
        ...
        String str1 = result.substring(5);//begin
        String str2 = result.substring(5, 10); //begin, end
